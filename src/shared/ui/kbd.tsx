...
function Kbd({ className, ...props }: React.ComponentProps<'kbd'>) {
  return (
    <kbd
      data-slot="kbd"
      className={cn(
        'pointer-events-none inline-flex h-5 min-w-5 items-center justify-center bg-muted px-1.5 text-[10px] font-normal leading-none text-foreground/90 select-none',
        'rounded-sm',
        ...
        '[[data-slot=tooltip-content]_&]:text-tooltip-foreground',
